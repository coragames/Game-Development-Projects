...
public class Enemy : CellObject
{
    ...
    private void Awake()
    {
        GameManager.instance._turnManager.OnTick += TurnHappened;
    }
    ...
    bool MoveTo(Vector2Int coord)
    {
        ...
        if (targetCell == null
            || !targetCell.passable
            || targetCell.containedFoodObject != null)
        {
            return false;
        }
        ...
        currentCell.containedFoodObject = null;
        
        //add it to the next cell
        targetCell.containedFoodObject = this;
        m_Cell = coord;
